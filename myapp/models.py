...
class Honkon_base(models.Model):
    id = models.BigAutoField(primary_key=True)
    # 商家
...
class Order(models.Model):
    ...
    # 合计
    total = models.DecimalField(max_digits=10, decimal_places=2, verbose_name="合计")
...
class reimburse(models.Model):
    reimburse_id = models.AutoField(primary_key=True)
    ...
    reimburse_price = models.DecimalField(max_digits=10, decimal_places=0)
...
class vehicle(models.Model):
    ...
    vehicle_price = models.DecimalField(max_digits=10, decimal_places=0)
